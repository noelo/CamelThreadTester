...
package com.redhat.gps.servlet.filter;
...
public class DoSFilter implements Filter
{
    ...
    private int __DEFAULT_MAX_REQUESTS_PER_SEC = 25;
    private int __DEFAULT_DELAY_MS = 100;
    private int __DEFAULT_THROTTLE = 5;
    private int __DEFAULT_WAIT_MS=50;
    private long __DEFAULT_THROTTLE_MS = 30000L;
    private long __DEFAULT_MAX_REQUEST_MS_INIT_PARAM=30000L;
    private long __DEFAULT_MAX_IDLE_TRACKER_MS_INIT_PARAM=30000L;
    ...
    public void setDEFAULT_MAX_REQUESTS_PER_SEC(int DEFAULT_MAX_REQUESTS_PER_SEC) {
		this.__DEFAULT_MAX_REQUESTS_PER_SEC = DEFAULT_MAX_REQUESTS_PER_SEC;
	}
	...
	public void setDEFAULT_THROTTLE(int DEFAULT_THROTTLE) {
		this.__DEFAULT_THROTTLE = DEFAULT_THROTTLE;
	}


	public void setDEFAULT_WAIT_MS(int DEFAULT_WAIT_MS) {
		this.__DEFAULT_WAIT_MS = DEFAULT_WAIT_MS;
	}


	public void setDEFAULT_THROTTLE_MS(long DEFAULT_THROTTLE_MS) {
		this.__DEFAULT_THROTTLE_MS = DEFAULT_THROTTLE_MS;
	}
	...
	public void setDEFAULT_MAX_IDLE_TRACKER_MS_INIT_PARAM(
			long DEFAULT_MAX_IDLE_TRACKER_MS_INIT_PARAM) {
		this.__DEFAULT_MAX_IDLE_TRACKER_MS_INIT_PARAM = DEFAULT_MAX_IDLE_TRACKER_MS_INIT_PARAM;
	}
	...
	public void init(FilterConfig filterConfig)
    {
		...
		LOG.warn("HERE 3 DEFAULT_DELAY_MS OF "+_delayMs);
